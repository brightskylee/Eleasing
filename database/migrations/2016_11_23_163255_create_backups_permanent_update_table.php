...
class CreateBackupsPermanentUpdateTable extends Migration {
	...
	public function up()
	{
		Schema::create('backups_permanent_update', function(Blueprint $table)
		{
	...
	{
		Schema::drop('backups_permanent_update');
	}
